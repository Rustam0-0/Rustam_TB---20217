        ...
        ?>
            <?php $row = $result->fetch_assoc() ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" disabled value="<?php echo $row['pro_ref']; ?>">
                </div>

                <div class="form-group">
                    <label>Catégorie :</label>
                    <input class="form-control" type="text" disabled value="<?php echo $row['cat_nom']; ?>">
                </div>

                <div class="form-group">
                    <label>Libellé :</label>
                    <input class="form-control" type="text" disabled value="<?php echo $row['pro_libelle']; ?>">
                </div>

                <div class="form-group">
                    <label>Description :</label>
                    <textarea rows="3" class="form-control" disabled value=""><?php echo $row['pro_description']; ?></textarea>
                </div>

                <div class="form-group">
                    <label>Prix :</label>
                    <input class="form-control" type="number" disabled value="<?php echo $row['pro_prix']; ?>">
                </div>

                <div class="form-group">
                    <label>Stock :</label>
                    <input class="form-control" type="number" disabled value="<?php echo $row['pro_stock']; ?>">
                </div>

                <div class="form-group">
                    <label>Couleur :</label>
                    <input class="form-control" type="text" disabled value="<?php echo $row['pro_couleur']; ?>">
                </div>

                    <p>Produit bloqué? :</p>
                    <div class="form-group">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="Radio1" name="custom" class="custom-control-input" disabled value="<?php echo $row['pro_bloque']; ?>">
                            <label class="custom-control-label" for="Radio1">Oui</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="Radio2" name="custom" class="custom-control-input" disabled value="<?php echo $row['pro_bloque']; ?>">
                ...
                <a class="btn btn-warning btn-lg" href="modif.php" role="button">Modifier</a>
                <a class="btn btn-danger btn-lg" href="supprim.php" role="button">Supprimer</a>
                </div>
        </form><br>
